...
{
    public class FlixmovieDbContext: DbContext
    {
        private IHttpContextAccessor _httpContextAccessor;

        public FlixmovieDbContext(DbContextOptions<FlixmovieDbContext> options,IHttpContextAccessor httpContextAccessor): base(options)
        {
            _httpContextAccessor = httpContextAccessor;
        }

        public FlixmovieDbContext(DbContextOptions<FlixmovieDbContext> options): base(options)
        {
        ...
        public override int SaveChanges()
        {
            ...
            foreach (var entityEntry in entries)
            {
                ...
                ((AuditableBaseEntity)entityEntry.Entity).LastModifed = DateTime.UtcNow;
